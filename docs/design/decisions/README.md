...
| [DEC-G1-03](./DEC-G1-03-bridge-install-and-upgrade.md) | Accepted for local development | App/Bridge 组成 Release Set；稳定路径、协议窗口、可信拉起和整体回滚已冻结 |
...
- Goal 1 开发构建使用明确的开发专用 bundle ID `dev.guoxudong.next-infra.dev`；它不得用于发布、Keychain 实测或可信 MCP 自动拉起。
